...
namespace LINQtoSQL
{
    public partial class LINQMasterDetailsForma : Form
    {
        private FilmoviDBDataContext db = new FilmoviDBDataContext();

        public LINQMasterDetailsForma()
        {
            InitializeComponent();
        }

        private void LINQMasterDetailsForma_Load(object sender, EventArgs e)
        {
            UcitajZanrove();
        }

        // Ucitava sve zanrove u gornji DGV
        private void UcitajZanrove()
        {
            try
            {
                ...
                // Sakrijemo sve pa prikazemo samo sto trebamo
        ...
        // Kada korisnik klikne na zanr - ucitava filmove tog zanra
        ...
        // Ucitava filmove za selektovani zanr u donji DGV
        private void UcitajFilmove(int idZanr)
        {
            try
            {
                ...
                // Sakrijemo sve kolone pa prikazemo samo sto trebamo
                foreach (DataGridViewColumn col in dgvFilmovi.Columns)
                    col.Visible = false;

                // Prikazemo samo ove kolone
        ...
        private void btnNovi_Click(object sender, EventArgs e)
        {
            ...
            Zanr selektovani = (Zanr)dgvZanrovi.SelectedRows[0].DataBoundItem;
            LINQFilmDetaljiForma forma = new LINQFilmDetaljiForma(selektovani.IdZanr);
            forma.ShowDialog();
            UcitajFilmove(selektovani.IdZanr);
        }
        ...
        private void btnIzmeni_Click(object sender, EventArgs e)
        {
            ...
            LINQFilmDetaljiForma forma = new LINQFilmDetaljiForma(selektovaniZanr.IdZanr, selektovaniFilm);
            forma.ShowDialog();
        ...
        private void btnObrisi_Click(object sender, EventArgs e)
        {
            ...
            if (potvrda == DialogResult.Yes)
            {
                try
                {
                    // Proveravamo da li film ima recenzije
                    ...
                    db.Films.DeleteOnSubmit(selektovani);
                    db.SubmitChanges();
        ...
        // Dugme LINQ UPIT
        private void btnLINQUpit_Click(object sender, EventArgs e)
        {
            LINQUpitForma forma = new LINQUpitForma();
            forma.ShowDialog();
        }
    }
}
